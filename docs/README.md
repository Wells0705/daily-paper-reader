...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-18 21:00:40 UTC<br>状态：成功</p>
</section>
...
<p>精读：《ContextWeave: A Real-World Workflow Benchmark》（8.0/10）, 《MemoryCPT: An End-to-End Agent Memory Framework for Cost-Performance Trade-off》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="ContextWeave: A Real-World Workflow Benchmark">ContextWeave: A Real-World Workflow Benchmark</span></li><li><span class="dpr-home-dashboard-paper-title" title="MemoryCPT: An End-to-End Agent Memory Framework for Cost-Performance Trade-off">MemoryCPT: An End-to-End Agent Memory Framework for Cost-Performance Trade-off</span></li><li><span class="dpr-home-dashboard-paper-title" title="Muscle Memory for Agents: Compile not Merely Retrieve">Muscle Memory for Agents: Compile not Merely Retrieve</span></li></ul>
  </div>
